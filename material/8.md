...
Like many other modern languages, Kotlin supports operator overloading. Unlike some other languages, it doesn't let you define any sequence of symbols as an operators, but instead, it confines you to a predefined set of operators that you may define for each type.
