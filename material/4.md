...
If we provide the type of the variable that holds a lambda on the left hand side, we can omit the type of the lambda's parameter, and let inference work the other way:
