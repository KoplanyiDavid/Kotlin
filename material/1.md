...
Who's using the language? A [very rapidly rising number of developers](https://youtu.be/PsaFVLr8t4E?t=366) - millions, by now. What are they using the language for? You can take a look at the [Kotlin Census](https://www.jetbrains.com/research/kotlin-census-2018/) ran by JetBrains for some statistics.
